"""
Example usage of Semantic Unit framework.
...
def main():
    ...
    if not os.getenv("OPENAI_API_KEY") and not os.getenv("SEMANTIC_UNIT_API_KEY"):
        print("⚠️  WARNING: No API key found!")
        print("Set OPENAI_API_KEY or SEMANTIC_UNIT_API_KEY environment variable")
    ...
    try:
        ...
        print("  or")
        print("  export SEMANTIC_UNIT_API_KEY='your-key-here'")
